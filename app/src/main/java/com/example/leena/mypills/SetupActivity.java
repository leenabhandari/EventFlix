...
//            }
    ...
    private void saveAccountInfo() {
        ...
        String addrr=addr.getText().toString();
        ...
        else if(TextUtils.isEmpty(addrr))
        {
    ...
    private void sendUserToMainActivity() {
        Intent mainIntent=new Intent(SetupActivity.this,Map_data.class);
