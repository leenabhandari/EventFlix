...
public class FindActivity extends AppCompatActivity {
    ...
    private ImageButton searchBtn,searchBtn1;

    private EditText searchName,searchName1;
...
//        lottieAnimationView = (LottieAnimationView) findViewById(R.id.search);
//
//        lottieAnimationView.playAnimation();

                //startActivity(new Intent(FindActivity.this, FindActivity.class));
        ...
        searchBtn1=(ImageButton)findViewById(R.id.find_user_btn11);
        searchBtn1.setBackgroundDrawable(null);
        searchName1=(EditText)findViewById(R.id.find_user_edit11);

        searchBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String find=searchName.getText().toString();
                displayTheEvent(find);
            }
        });
        ...
        searchBtn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String find=searchName1.getText().toString();
                displayTheUser(find);
            }
        });
    ...
    private void displayTheUser(String find) {
        ...
        Query findUser=userRef.orderByChild("Email").startAt(find.toLowerCase()).endAt(find.toLowerCase()+"\uf8ff");
    ...
    private void displayTheEvent(String find) {
        //Toast.makeText(this,"Finding...",Toast.LENGTH_SHORT).show();
        Query findEven=eventref.orderByChild("Description").startAt(find.toLowerCase()).endAt(find.toLowerCase()+"\uf8ff");
        FirebaseRecyclerAdapter<Event, FindViewHolder1> firebaseRecyclerAdapter =
                new FirebaseRecyclerAdapter<Event, FindViewHolder1>
                        (
                                Event.class,
                                R.layout.indi_event,
                                FindViewHolder1.class,
                                findEven
                        )
                {
                    @Override
                    protected void populateViewHolder(FindViewHolder1 viewHolder, Event model, int position)
                    {
                        final String userKey=getRef(position).getKey();
...
//                        });
    ...
    public static class FindViewHolder1 extends RecyclerView.ViewHolder{
        View mView;
        public FindViewHolder1(View itemView) {
            super(itemView);
            mView=itemView;
        }
        ...
        {
            TextView name=(TextView)mView.findViewById(R.id.individual_name1);
            name.setText(fullname);
        }

        public void setTiming(String age)
        {
            TextView ageview=(TextView)mView.findViewById(R.id.individual_age1);
            ageview.setText(age);
        }

        public void setType(String age)
        {
            TextView ageview=(TextView)mView.findViewById(R.id.individual_points1);
            ageview.setText(age);
        }
        public void setOrganiser(String age)
        {
            TextView ageview=(TextView)mView.findViewById(R.id.individual_username1);
            ageview.setText(age);
        }



        public void setImageURL(String profile_img)
        {
            CircleImageView profile=(CircleImageView)mView.findViewById(R.id.individual_profile_img1);
            Picasso.get().load(profile_img).placeholder(R.drawable.profile).into(profile);
        }
    }
    ...
    private void sendUserToMainActivity() {
        Intent mainIntent=new Intent(FindActivity.this,Map_data.class);
